...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text='🏭join hogwarts', url='https://t.me/joinchat/wPEojnfzfdcwMmU1'),
        InlineKeyboardButton(text='🥇Hogwarts Chanel', url='https://t.me/HogwartsPlus')]]
